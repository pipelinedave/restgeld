...
describe('BudgetDisplay', () => {
  ...
  it('farbe gruen bei ersparnis > 0', () => {
    ...
    expect(wrapper.find('.hero-amount').classes()).toContain('color-green')
  ...
  it('farbe weiss bei ersparnis == 0', () => {
    ...
    expect(wrapper.find('.hero-amount').classes()).toContain('color-white')
  ...
  it('farbe rot bei ersparnis < 0', () => {
    ...
    expect(wrapper.find('.hero-amount').classes()).toContain('color-red')
