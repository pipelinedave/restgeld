...
export const translations: Record<SupportedLocale, Record<string, string>> = {
  de: {
    ...
    'settings.push_heading': 'Benachrichtigungen',
    'settings.push_desc': 'Erhalte Hinweise und Erinnerungen als Push-Benachrichtigung auf diesem Gerät.',
    'settings.push_toggle': 'Push-Benachrichtigungen aktivieren',
    'settings.push_test_btn': '🔔 Test-Benachrichtigung senden',
  ...
  en: {
    ...
    'settings.push_heading': 'Notifications',
    'settings.push_desc': 'Receive alerts and reminders as push notifications on this device.',
    'settings.push_toggle': 'Enable push notifications',
  ...
  es: {
    ...
    'settings.push_heading': 'Notificaciones',
    'settings.push_desc': 'Recibe avisos y recordatorios como notificaciones push en este dispositivo.',
    'settings.push_toggle': 'Activar notificaciones push',
    'settings.push_test_btn': '🔔 Enviar notificación de prueba',
  ...
  fr: {
    ...
    'settings.push_heading': 'Notifications',
    'settings.push_desc': 'Recevez des alertes et rappels en tant que notifications push sur cet appareil.',
    'settings.push_toggle': 'Activer les notifications push',
    'settings.push_test_btn': '🔔 Envoyer une notification de test',
